...
public class Main {
	public static void main(String args[]) {
		Accounts a1 = new Accounts("Kartik",101,1000);
		Accounts a2 = new Accounts("kartik",101,1000);  
		Accounts a3 = new Accounts("kumar",102,2000); 
		Accounts a4 = new Accounts("kk",103,3000); 
		Accounts a5 = new Accounts("mk",104,4000); 
		Accounts a6 = new Accounts("ms",105,5000); 
